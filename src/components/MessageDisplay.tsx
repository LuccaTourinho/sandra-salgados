...
const MessageDisplay = () => {
  return (
    <div className='flex flex-col items-center justify-between gap-4 xl:gap-8'>
        <h2 className='text-md xl:text-2xl font-extralight text-text-950'>
            Delícias que fazem toda <br/>
            diferença no seu evento
        </h2>
        <p className='text-xs md:text-md font-extralight text-text-950 w-[200px] xl:w-[300px]'>
