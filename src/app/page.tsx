  ...
  return (
    <motion.section 
      ...
      <div className="container mx-auto flex flex-col items-center justify-center gap-4">
        <h1 className="text-md sm:text-lg md:text-4xl font-semibold uppercase text-text-950 text-center">
        ...
        <div className={`flex flex-col lg:flex-row items-center justify-around gap-2 xl:gap-3`}>
          <MessageDisplay />
          <HeroCarroseul />
        </div>
      </div>
